  ...
  return (
    <>
      ...
      <section id="about-us" className="about-us" style={{marginTop: '40px'}}>
         ...
         <h2 style={{fontWeight: 'bold', fontFamily: 'Montserrat, sans-serif', textAlign: 'left'}}>State Symbols</h2>
<hr></hr>
<p>The official state symbols of Assam embody the region's rich cultural heritage and natural wonders.</p>
