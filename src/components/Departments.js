...
const Departments = () => {
  ...
  const { name,lname,regno,email,contact,dept,dept2,time,date,approval } = data;
  ...
  const getSingleBlog = async () => {
    ...
    const snapshot = await getDoc(docRef, "Departments");
    if (snapshot.exists()) {
      setData({ name,lname,regno,email,contact,dept,dept2,time,date,approval, });
    }
  };
  ...
  const ref = db.collection("FormsControl").orderBy('no').startAt('1').endAt('1')
...
<div className="row">
                ...
                <div className="row">
                 ...
                 <Form.Field  label="Department" style={{height:'4.8vh'}} name="dept" control='select' value={dept} 
                  ...
                  <div className="col-lg my-2"> 
                  <Form.Field  label="Department (Preference-II)" style={{height:'4.8vh'}} name="dept2" control='select' value={dept2} 
                       onChange={handleChange} >
