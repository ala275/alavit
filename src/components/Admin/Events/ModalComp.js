...
const ModalComp = ({ open, setOpen,img, name, info, info2, info3, date, time, ddate, dtime, users,id, handleDelete}) => {
		...
		<div className="container-fluid">
			<div className="row">
				...
				<div className="wishlist-border pt-4" style={{color: 'grey',}}>
					<i>Desc:</i> <span className="wishlist" style={{fontSize: '13px',color: 'black'}}>{info}<br></br><br></br>{info2}<br></br><br></br>{info3}</span>
				</div>
