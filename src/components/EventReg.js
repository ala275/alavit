...
const EventReg = () => {
  ...
  const { name, regno, email, contact, time, date, status } = data;
        ...
        <div className="content">
          <div className="row">
            <div className="col-lg-6" style={{ marginTop: "2vh" }}>
              <img
                style={{ width: "100%" }}
                src="http://www.travelspeak.in/assets/resources/Bohag-Bihu-Dance-Assam.jpg"
                alt=""
              />
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <h2 style={{ fontWeight: "bold", color: "orange" }}>
                    ব’হাগী উৎসৱ | Bohagi Utsav
                  </h2>
                  <br></br>
                  <br></br>
                  <p style={{ fontSize: "13px" }}>
                    <i style={{ color: "grey" }}>Details:</i> <br></br>Venue:{" "}
                    <b style={{ color: "orange" }}>MB-210</b> | Date:{" "}
                    <b style={{ color: "orange" }}>6th April</b> | Time:{" "}
                    <b style={{ color: "orange" }}>5-7PM</b>
                  </p>
                  <hr></hr>
                  {isSubmit ? (
